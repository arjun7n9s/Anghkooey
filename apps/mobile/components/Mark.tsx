...
export function Mark({ size = 22 }: { size?: number }) {
  const height = size;
  return (
    <Svg width={size} height={height} viewBox="0 0 22 22" fill="none">
      <Circle cx="11" cy="11" r="10" fill={theme.wax} opacity={0.12} />
      <Circle cx="11" cy="11" r="9.25" stroke={theme.wax} strokeWidth={1.25} />
      <Path
